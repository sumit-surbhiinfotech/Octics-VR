        ...
        <header className="page-topbar" id="header">
            ...
            <nav className="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-indigo-purple no-shadow">
                ...
                <ul className="navbar-list right">
                    ...
                    <li><a className="waves-effect waves-block waves-light profile-button" href="#!;" data-target="profile-dropdown"><span className="avatar-status avatar-online"><img src="images/avatar/avatar-7.png" alt="avatar" /><i></i></span></a></li>
                </ul>
