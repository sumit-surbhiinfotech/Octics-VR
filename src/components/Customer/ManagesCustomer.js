...
const data = [
    {
        ...
        Action:
            <div>
                ...
                <NavLink to="/customer-view"><button className=" btn gradient-45deg-red-pink z-depth-4 mr-1 mb-2  pt-1"><span className="material-icons">remove_red_eye </span></button></NavLink>
            </div>,
    },
    {
        key: '2',
...
const ManagesCustomer = () => {
    ...
    return (
        <>
            <Header />
            <Sidebar />
            <div className="manages-customer">
                <div id="main">
                    <div className="row">
                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col s10 m6 l6">
                                        <h5 className="breadcrumbs-title mt-0 mb-0"><span>Manage Customers</span></h5>
